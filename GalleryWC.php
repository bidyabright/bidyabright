<!-- SQL TABLE : sql_table_gallerywc
SQL TABLE ROW : GalleryWC_Heading,GalleryWC_Paragraph,GalleryWC_Code,GalleryWC_Output,GalleryWC_Note
SQL CONNECTION ID : $PluginsParagraph,'$PluginsCode,$PluginsOutput,$PluginsNote
TEXTBOX NAME : GalleryWC_Heading,GalleryWC_Paragraph,GalleryWC_Code,GalleryWC_Output,GalleryWC_Note
...
<body>
	...
	<?php
		...
		$sel_query="Select * from sql_table_gallerywc ORDER BY id desc;"; //SQL QUERY ALL IS REQUIRYED id is important
	...
	<div class="col-12 col-sm-4">
		<div class="card card-shadow M-B-30">
			...
			<h4 class="card-title"><?php echo $row["GalleryWC_Heading"]; ?></h4>
			<div class="card-block">
			<?php if($row['GalleryWC_Heading'] != ""): ?>
			<img src="uploads/<?php echo $row['GalleryWC_Output']; ?>" width="100%" height="auto" class="card-img-top">
			<?php else: ?>
			...
			<?php endif; ?>
				...
				<div class="card-footer">
					<p class="card-text"><small class="text-muted"><?php echo $row["GalleryWC_Note"]; ?></small></p>
