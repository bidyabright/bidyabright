...
SQL TABLE ROW : GalleryGA_Heading,GalleryGA_Paragraph,GalleryGA_Code,GalleryGA_Output,GalleryGA_Note
SQL CONNECTION ID : $PluginsParagraph,'$PluginsCode,$PluginsOutput,$PluginsNote
TEXTBOX NAME : GalleryGA_Heading,GalleryGA_Paragraph,GalleryGA_Code,GalleryGA_Output,GalleryGA_Note
...
<body>
	...
	<?php
		...
		$sel_query="Select * from sql_table_galleryga ORDER BY id desc;"; //SQL QUERY ALL IS REQUIRYED id is important
	...
	<div class="col-12 col-sm-4">
		<div class="card card-shadow M-B-30">
			...
			<h4 class="card-title"><?php echo $row["GalleryGA_Heading"]; ?></h4>
			<div class="card-block">
			<?php if($row['GalleryGA_Heading'] != ""): ?>
			<img src="uploads/<?php echo $row['GalleryGA_Output']; ?>" width="100%" height="auto" class="card-img-top">
			<?php else: ?>
			...
			<?php endif; ?>
				...
				<div class="card-footer">
					<p class="card-text"><small class="text-muted"><?php echo $row["GalleryGA_Note"]; ?></small></p>
